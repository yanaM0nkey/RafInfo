...
public class AnnouncementAddFragment extends BaseFragment implements DatePickerListener, TimePickerListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_add_edit_announcement, container, false);
        ...
        tlDescription = view.findViewById(R.id.faea_description_layout);
    ...
    public void onDateSelected() {
        etDate.setText(datePicker.getSelectedDate());
    }

    @Override
    public void onTimeSelected() {
        etTime.setText(timePicker.getSelectedTime());
    }
}
